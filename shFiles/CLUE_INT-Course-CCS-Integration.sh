...
defxls=/opt/code/ccs-soapui-tests/Data/CLUE_INT_CDF.xls
XLS=${7-$defxls}
...
sh /opt/SoapUI-5.1.3/bin/testrunner.sh -e$HOST -s"CLUE CCS API Integration ProjectTestSuite" -PXLPath=$XLS -r -a -f/opt/code/Reports /opt/code/ccs-soapui-tests/CLUE_Course-E2E_cdf_project.xml