...
defxls=/opt/code/ccs-soapui-tests/Data/SoapUI_STAGE_e2e_4LTR.xls
XLS=${7-$defxls}
...
echo $PATH
mvn -version
mvn clean test -Denv.CBURL=https://s-c-login.cengage.com/cb/login.htm -Denv.OLRURL=http://s-c-olradmin.cengage.com/olr/admin/index.jsp -Denv.USER=$USER -Denv.PASS=$PASS -Denv.OLRUSER=$OLRUSER -Denv.OLRPASS=$OLRPASS -Denv.XLS=$XLS -Denv.PRODUCT='Lamb/Hair/McDaniel, MKTG (with Online, 1 term (6 months) Printed Access Card), 9th Edition'
