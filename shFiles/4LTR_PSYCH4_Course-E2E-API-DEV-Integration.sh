...
defxls=/opt/code/ccs-soapui-tests/Data/SoapUI_DEV_e2e_4LTR.xls
XLS=${7-$defxls}
...
mvn clean test -Denv.CBURL=https://d-login.cengage.com/cb/login.htm -Denv.OLRURL=http://d-olradmin.cengage.com/olr/admin/index.jsp -Denv.USER=$USER -Denv.PASS=$PASS -Denv.OLRUSER=$OLRUSER -Denv.OLRPASS=$OLRPASS -Denv.XLS=$XLS -Denv.PRODUCT='Rathus, PSYCH4 (with Online, 1 term (6 months) Printed Access Card), 4th Edition'
