...
sh /opt/SoapUI-5.1.3/bin/testrunner.sh -e$HOST -s"Gradebook_Token_Generator" -PXLPath=$XLS -r -a -f/opt/code/Reports /opt/code/ccs-soapui-tests/Gradebook_E2E_Phase2-soapui-project.xml
