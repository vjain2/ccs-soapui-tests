...
sh testrunner.sh -s"Gradebook_QA_Env" -r -a -f/Users/mindtap/SOAPUI/Reports /Users/mindtap/SOAPUI/ccs-soapui-tests/Gradebook-QA-Env-phase_2-soapui-project.xml
