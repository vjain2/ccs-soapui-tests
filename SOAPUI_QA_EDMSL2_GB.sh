...
sh testrunner.sh -s"EDMS_GB_Term_Assets" -r -a -f/Users/mindtap/SOAPUI/Reports /Users/mindtap/SOAPUI/ccs-soapui-tests/SOAPUI_QA_EDMSL2_GB-soapui-project.xml