...
sh testrunner.sh -s"SOAPUI QA - EDMSL2 GB" -r -a -f/Users/mindtap/SOAPUI/Reports /Users/mindtap/SOAPUI/ccs-soapui-tests/EDMS_Lite_Validation-soapui-project.xml